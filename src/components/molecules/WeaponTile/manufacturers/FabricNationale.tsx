...
export const FabricNationale = ({fill}: FnProps) => {
	return (
		<svg xmlns="http://www.w3.org/2000/svg" fill={fill} width="100%" height="auto">
			<g id="g41" transform="translate(-28.2 -30.43)">
				<g id="g19" >
					<g id="g17" >
						<path id="path5"
						...
						<path id="path11"
							  ...
							  className="st1" />
						<path id="polygon13" d="M170.4 81.3l3.7 5.2-3.7 5.2-3.7-5.2z" className="st1"
							  />
						<path id="path15"
